...
import com.example.xavier.fireprotect.backendgcm.messaging.Messaging;
import com.example.xavier.fireprotect.gcm.QuickstartPreferences;
import com.example.xavier.fireprotect.gcm.RegistrationIntentService;
    ...
    public void onClickButton (View v) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    message.messagingEndpoint().sendMessage("Missatge FireProtect").execute();
                } catch (IOException e) {
                    e.printStackTrace();
                }
                return null;
